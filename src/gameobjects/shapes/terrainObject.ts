...
export class TerrainObject {
    ...
    constructor(scene: THREE.Scene,
        ...
        var shaderMaterial = this.generateShaderMaterial(planeSize, heightMapTextureAsArray.getAssetName(), displacementHeightFactor);
        this.generateSplattedMeshFromDisplacementPlane(scene, height, width, displacementHeightFactor, shaderMaterial);
    ...
    generateShaderMaterial(planeSize: number, asset: string, displacementHeightFactor: number ): THREE.Material {
